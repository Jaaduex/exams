...
class HashTable {
    ...
    public HashTable(int size) {
        ...
        for (int i = 0; i < tableSize; i++) {
            ...
            deleted[i] = false; // Initially, no slots are deleted
        }
    }
    ...
    public void insert(int key) {
        ...
        while (table[index] != Integer.MIN_VALUE && table[index] != key && !deleted[index]) {
        ...
        table[index] = key;
        deleted[index] = false; // Mark as not deleted
